---
id: pull-requests
title: Module 03 - Pull Requests and Reviews
...
- Use follow-up issues for big items that do not block the current PR.
- After merging, clean up the branch and note lessons learned.

## Done checklist

- [ ] You opened a practice PR against your sandbox repo (even if it is just documentation).
- [ ] You reviewed a classmate's PR using the checklist above (or self-reviewed using GitHub's review tool).
- [ ] Branch deleted after merge.

Next module: **Deliverables and automation**.
