...
| macOS | `brew install git` | If you do not use Homebrew, the first git command will prompt you to install the Xcode Command Line Tools. |
...
2. The credential manager stores a token so you will not re-enter it every time.
